  ...
  return (
    ...
    >
      ...
      <div className=" flex items-center gap-2">
        ...
        />
        <SearchIcon className="w-5 h-5 cursor-pointer  duration-150 group-hover:text-blue-400" />
      </div>
      <AnimatePresence>
          ...
          >
            {isLoading ? (
              ...
              games?.data.results.map((game: any) => (
                <div key={game.id} className="hover:bg-blue-600 duration-200 flex flex-col gap-2 px-4 py-2">
