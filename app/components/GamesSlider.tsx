    ...
    <div>
      <div className=" flex flex-col gap-6 mt-14">
        <div className=" w-full justify-between flex items-center">
          <Heading text={title} />
          <Link className=" text-blue-300 font-semibold" href="/category">
            {" "}
            Browse All Games
          </Link>
        </div>
            ...
            return {
              card: big ? (
                ...
                <div className=" relative cursor-pointer group">
                 ...
                 after:w-0 group-hover:after:w-full after:h-full after:bg-blue-500/60 after:rounded-2xl after:duration-200  w-full h-96 rounded-2xl overflow-hidden relative "
                  >
                    <Image
                      className=" group-hover:scale-125 group-hover:rotate-6 duration-200 object-cover"
                      fill
